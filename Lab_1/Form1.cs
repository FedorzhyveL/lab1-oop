...
namespace Lab_1
{
    public partial class Lab_1 : Form
    {
        ...
        private void btn_restart_Click(object sender, EventArgs e)
        {
            ...
            Thread.Sleep(TimeSpan.FromSeconds(_orderFulfilmentTimeInterval));
            for (int i = 0; i < orderNumberGridView.Rows.Count;)
            {
                orderNumberGridView.Rows.RemoveAt(i);
            }
            RestaurantManager.restart();
            source.Dispose();
            OrderTaker.orderCounter = 0;
